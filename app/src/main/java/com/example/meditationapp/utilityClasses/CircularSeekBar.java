...
public class CircularSeekBar extends View {
    ...
    private static final int DEFAULT_CIRCLE_PROGRESS_COLOR = Color.WHITE;
    ...
    private static final int DEFAULT_POINTER_HALO_COLOR = Color.RED;
    //    private static final int DEFAULT_POINTER_HALO_COLOR_ONTOUCH = Color.argb(135, 74, 138, 255);
    private static final int DEFAULT_POINTER_HALO_COLOR_ONTOUCH = Color.RED;
